...
class _ControllerPageState extends State<ControllerPage> {
  ...
  // UUID สำหรับใช้จับคู่สัญญาณบลูทูธกับบอร์ด ESP32 ของคุณ
  ...
  void initState() {
    super.initState();
    // ระบบตรวจเช็กสถานะเพื่อบังคับเปิดบลูทูธบนมือถือเวลาจะเชื่อมต่อเครื่อง
  ...
  // ฟังก์ชันเริ่มสแกนค้นหาสัญญาณจากบอร์ด ESP32 จริง ๆ
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // แถบหัวข้อด้านบนสุด ปรับแก้ไขข้อความสั้นกระชับพร้อมชื่อสถาบันตามสั่ง
      appBar: AppBar(
        title: const Column(
          children: [
